export const navigation = [
  ...
  },
  {
    ...
    title: "Hooks",
    subtitle:
      "Fold React Hooks provide various pieces of functionality that can make complex logic simple.",
  ...
  },
  {
    ...
    title: "Task",
    subtitle:
      "The Task component represents an item on a todo list or card on a kanban board.",
    description:
