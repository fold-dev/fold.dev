    ...
    return (
        <View>
            ...
            <View p={100}>
                ...
                <h2>Refunds</h2>
                <p>Johannes du Plessis (Fold) offers limited refunds on SOFTWARE within 14 days of purchase. Contact licensing@fold.dev for assistance.</p>
                <p>If we issue a refund, you agree to delete all files within 24 hours and are not permitted to use SOFTWARE in projects (including personal/non-commercial projects).</p>
