...
export const docs = {"title":"Common","subtitle":"Common components are shared components used by the Kanban Board, Todo List & Calendar components.","description":"These components offer a unified experience when interacting with the rest of the Pro components. They are meant as examples, that can be easily extended."}
