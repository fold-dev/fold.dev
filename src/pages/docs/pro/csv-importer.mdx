...
export const docs = {"title":"CSV Importer","subtitle":"Make sense of imported data by correctly mapping columns with the CSV Importer.","description":"The CSV Importer component offers a streamlined way of onboarding complex data - ideal for customer success, onboarding & data teams.","experimental":true}
