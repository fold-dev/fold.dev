...
export const docs = {"title":"Todo List","subtitle":"Organize your life like a boss with the Todo List component.","description":"The Todo List component is a powerful, but extremely flexible addition to any project or task management solution. Included is a rich-input experience."}
